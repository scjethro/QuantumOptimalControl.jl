...
struct ClosedStateTransfer <: ClosedProblem
    ...
    drift_ham::Union{Array{Complex, 2}, Function}
    ...
    control_hams::Union{Array{Array{Complex, 2}, 1}, Function}
    # want to store the states as density matrices for convenience, is there a reason to store psi?
    initial_state::Array{Complex, 2}
    final_state::Array{Complex, 2}
